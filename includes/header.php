...
<aside class="sidebar">
  ...
  <a href="/pos/vibe/admin/dashboard.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : '' ?>"><span class="icon">◈</span> Dashboard</a>
  <div class="nav-section">Manage</div>
  <a href="/pos/vibe/admin/orders.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'orders.php' ? 'active' : '' ?>"><span class="icon">⊞</span> Orders</a>
  <a href="/pos/vibe/admin/products.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'products.php' ? 'active' : '' ?>"><span class="icon">⊟</span> Products</a>
  <a href="/pos/vibe/admin/users.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'users.php' ? 'active' : '' ?>"><span class="icon">⊕</span> Users</a>
  <a href="/pos/vibe/admin/customer_types.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'customer_types.php' ? 'active' : '' ?>"><span class="icon">◎</span> Customer Types</a>
  <a href="/pos/vibe/admin/payment_types.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'payment_types.php' ? 'active' : '' ?>"><span class="icon">⊗</span> Payment Types</a>
